...
class AvailabilitiesControllerTest < ActionController::TestCase
  ...
  test "should create availability" do
    assert_difference('Availability.count') do
      post :create, availability: { end: @availability.end, provider_id: @availability.provider_id, start: @availability.start }
    end
  ...
  test "should update availability" do
    patch :update, id: @availability, availability: { end: @availability.end, provider_id: @availability.provider_id, start: @availability.start }
    assert_redirected_to availability_path(assigns(:availability))
  end
